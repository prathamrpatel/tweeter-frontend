...
// Template found at: https://chakra-templates.dev/navigation/sidebar
...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Messages', icon: FiMessageCircle, link: '/' },
  ...
  return (
    ...
    >
      <Flex h="20" alignItems="center" mx="8" justifyContent="space-between">
        ...
        {isOpen ? null : <ColorModeSwitch />}
        <CloseButton display={{ base: 'flex', md: 'none' }} onClick={onClose} />
      </Flex>
      {LinkItems.map((link) => (
        <NextLink href={link.link} key={link.name}>
            ...
            >
              <HStack>
                ...
                <VStack
                  ...
                  ml="2"
                >
                  <Text fontSize="sm">{data?.currentUser?.name}</Text>
